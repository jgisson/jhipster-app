package jgisson.jhipster.app.config;
...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "myjHipsterApp@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "myjHipsterApp API";

        private String description = "myjHipsterApp API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "myjHipsterApp";
